 ...
 * <p>
 * Классы, реализующие этот интерфейс, должны предоставлять возможность:Получения инстанса класса со
 * всеми иньекциями по классу интерфейса, регистрации байндинга по классу интерфейса и его
 * реализации, регистрации синглтон класса.
 *
